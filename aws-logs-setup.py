...
class CloudWatchLogsAgentSetup:
    Rhel, Ubuntu, AmazonLinux, CentOS, Raspbian, Debian, Kali = range(7)
    ...
    def setup_initd(self):
        ...
        if self.os_flavor == self.Debian or self.os_flavor == self.Ubuntu or self.os_flavor == self.Kali:
    ...
    def setup_agent_as_daemon(self):
        ...
        if self.os_flavor == self.AmazonLinux or self.os_flavor == self.Ubuntu or self.os_flavor == self.Rhel or self.os_flavor == self.CentOS or self.os_flavor == self.Raspbian or self.os_flavor == self.Debian or self.os_flavor == self.Kali:
            self.setup_initd()
        else:
